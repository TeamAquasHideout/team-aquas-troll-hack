static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 27, 1},
    ...
    [HEAL_LOCATION_AQUA_HIDEOUT - 1] = {MAP_GROUP(AQUA_HIDEOUT_B2F), MAP_NUM(AQUA_HIDEOUT_B2F), 17, 11},
};
